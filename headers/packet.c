 ...
 *
 * $Id: packet.c 41216 2012-02-28 03:19:49Z morriss $
 *
...
static void
dissector_dump_heur_decodes_display(const gchar *table_name, const gpointer value, const gpointer user_data)
{
...
dissector_dump_decodes_display(const gchar *table_name,
			       ftenum_t selector_type , const gpointer key, const gpointer value,
			       gpointer user_data)
{
